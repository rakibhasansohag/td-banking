...
export const createLinkToken = async (user: User) => {
  try {
    const tokenParams = {
      ...
      country_codes: ["US"] as CountryCode[], // optional
    };
...
export const exchangePublicToken = async ({
  ...
  try {
    ...
    // Get account information from Plaid using the access token and item ID
    ...
    // Create a funding source URL for the account using the Dwolla customer ID, processor token, and item ID/ bank name;
